...
#------------------------------------------------------------------------------        
        self.add_dataset(Dataset('dig.mu2e.fele0b1s41r0000.HelixAna.art','fele0b1s41r0000','local'));


    def __init__(self,idsid=None):
        familyID                     = 'fele0b1'
        
        ProjectBase.__init__(self,project='HelixAna',family_id='fele0b1',idsid=idsid);
        self.init_datasets();
...
#------------------------------------------------------------------------------
        s                            = self.new_stage('s5');
        job                          = s.new_job('reco_stn','fele0b1s41r0000'); #idsid);

        job.fNInputFiles             = 2000                     # number of the job segments
