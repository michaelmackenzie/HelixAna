...
#------------------------------------------------------------------------------        
        self.add_dataset(Dataset('dig.mu2e.mnbs0b2s41r0000.HelixAna.art','mnbs0b2s41r0000','local'));


    def __init__(self,idsid=None):
        familyID                     = 'mnbs0b2'
        
        ProjectBase.__init__(self,project='HelixAna',family_id='mnbs0b2',idsid=idsid);
        self.init_datasets();
...
#------------------------------------------------------------------------------
        s                            = self.new_stage('s5');
        job                          = s.new_job('reco_stn','mnbs0b2s41r0000'); #idsid);
